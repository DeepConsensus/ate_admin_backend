...
module.exports = {
    ...
    async aadharExists(aadhar_number, contact_number) {
        return new Promise((resolve, reject) => {
            User.findOne({
                    aadhar_number,
                    contact_number
                ...
                (err, item) => {
                    itemAlreadyExists(err, item, reject, 'AADHAR_NUMBER_ALREADY_EXISTS')
                    resolve(false)
                }
            )
        })
    ...
    async facebookExists(fid) {
        return new Promise((resolve, reject) => {
            User.findOne({
                    fid
                },
                (err, item) => {
                    itemAlreadyExists(err, item, reject, 'FACEBOOK_ALREADY_EXISTS')
                    resolve(false)
                }
            )
        })
